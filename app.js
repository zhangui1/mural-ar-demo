...
function closeActiveObject(objectId) {
  activeObjectIds = activeObjectIds.filter(function (activeObjectId) {
    return activeObjectId !== objectId;
  });

  updateActivePolygonClass();
  updateInfoCard();
  hideObjectTooltip();
  console.log("Active object closed:", objectId);
}
